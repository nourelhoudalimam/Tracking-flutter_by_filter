...
import 'package:my_api/View/InutFilterVehicule.dart';  // Import your Device model
...
class _MapWidgetState extends State<MapByFilter> {
 ...
 Future<void> _clearData() async {
  ...
  void initState() {
    ...
    widget.controller.initializeListdeviceByFilter(widget.filterValue);
...
void updateDeviceLocation(Map<String, double> location) {
 ...
 Future<void> moveDevice() async {
  try {
    await widget.controller.getVehicleLocationByFilter(widget.filterValue);
