...
class ListChauffeurparFiltre extends StatefulWidget {
  String filterValue;
  final ApiService apiService;

  ListChauffeurparFiltre({required this.filterValue, required this.apiService});

  @override
  State<StatefulWidget> createState() => _ListNotePage();
}

class _ListNotePage extends State<ListChauffeurparFiltre> {
  ...
  void initState() {
    ...
    controller.initializeListChauffeur(widget.filterValue);
  }
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return ListTile(
                      ...
                      subtitle: Text(controller.chauffeur[index].filter),
                      trailing: Row(
                        ...
                        children: [
                          IconButton(
                            onPressed: () async {
                              ...
                              await controller.initializeListChauffeur(widget.filterValue);
                            },
                                ...
                                builder: (context) => AlertDialog(
                                  ...
                                  content: SingleChildScrollView(
                                    child: Column(
                                      mainAxisSize: MainAxisSize.min,
                                      children: [
                                        Text(controller.chauffeur[index].id),
